...
{
    string str;
    SistemaGerenciaFolha folha = SistemaGerenciaFolha(20000);

    folha.getFuncionarios().push_back(new Assalariado("Joao", 12345, 300));
    folha.getFuncionarios().push_back(new Horista("Maria", 12346, 5, 48));
    folha.getFuncionarios().push_back(new Comissionado("Cosmo", 12344, 150, 1000, 10.5)); 
